...
public class JungleToolMaterial implements ToolMaterial {
    private static final int DURABILITY = 85;
    ...
    private static final Ingredient REPAIR_INGREDIENT = Ingredient.ofItems(Items.JUNGLE_PLANKS);
