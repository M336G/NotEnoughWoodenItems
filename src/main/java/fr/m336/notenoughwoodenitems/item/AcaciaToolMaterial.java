...
public class AcaciaToolMaterial implements ToolMaterial {
    private static final int DURABILITY = 95;
    ...
    private static final Ingredient REPAIR_INGREDIENT = Ingredient.ofItems(Items.ACACIA_PLANKS);
