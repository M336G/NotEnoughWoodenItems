...
public class BirchToolMaterial implements ToolMaterial {
    private static final int DURABILITY = 65;
    private static final float MINING_SPEED_MULTIPLIER = 2.5F;
    ...
    private static final Ingredient REPAIR_INGREDIENT = Ingredient.ofItems(Items.BIRCH_PLANKS);
